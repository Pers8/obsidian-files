...
The above object is a cryogenic electron microscope, a novel imaging technique that enables scientists to view microorganisms at cryogenic temperatures. This scientific apparatus has been included in the exhibition primarily because I had first-hand experience with a compound microscope while doing practical experiments in the biology laboratory. The cryo-EM has also aided and sped the development of COVID-19 vaccines and treatments.
In terms of answering the prompt, the microscope is an apt example of our ability to use our technological and biological knowledge to further the interests of humanity. The COVID - 19 pandemic has facilitated the enhanced usefulness of knowledge and the cryo - EM itself. It can be said that the urgency of the situation warrants an increased use of the cryo — EM, making it seem more useful over other forms of knowledge. As an example, on February 15, 2020, researchers at the University of Texas, Austin and the National Institutes of Health were successful at using the microscopes in order to identify the spike protein of SARS CoV-2, which was a key factor in understanding how to target the virus. As a result, it is clear that the value of knowledge is determined by the situation in which it is implemented.
If we went back to around ten years ago, our efforts would not be focused on improving our knowledge of viruses or developing vaccines, indicating a reduction in both the pursuit and usability of microbiology expertise. Furthermore, biological research scientists working in labs would be the only ones interested in such information. Nowadays, however, even commonplace individuals pursue access to such information in order to better understand the current circumstances. Therefore, we can see how different forms of knowledge are regarded as being more valuable than others, whereas in reality, 'usefulness' can only be determined based on which situation the knowledge is being applied to.




The above object is a photograph of a Little Boy Bomb model, the first atomic bomb used in warfare in world history. The bombing took place in the Japanese city of Hiroshima, as retaliation by the Americans during WW2. My passion for wartime films set during World War II, such as Dunkirk and Saving Private Ryan, led me to include this object. 
In response to the prompt, the dropping of the 'Little Boy' would have benefited the Americans during WWII, since they believe that the knowledge was used for a justified reason, an act of revenge. On the other hand, from the perspective of Japanese citizens, the implementation of the same knowledge appears to be harmful and terrifying. The subjective attitude of Japanese citizens toward the object's usefulness is influenced by their feelings and emotions. This highlights how the utility of different types of knowledge is relative. Around 70,000 people, including American soldiers, are estimated to have perished as a result of the Little Boy bombing. Moreover, by the end of 1945, because of the continuing effects of radioactive fallout and other after-effects, including radiation poisoning, the Hiroshima death toll was likely over 100,000. 
The "Little Boy" Bomb, although being a highly advanced and well-developed object, is not valuable to a specific group, demonstrating how advancements in a field may not always bring productive outcomes. Furthermore, if the need for a specific result is strong enough, the knowledge will be implemented in a way that maximises utility. On the other hand, the degree of usefulness of the same knowledge would be minuscule if the desire for a specific result was driven by a weak intention. As a result, this bomb is representative of an object whose knowledge is being used in such a way that its utility is largely dependent on the person using it.

The third object is an article by the BBC regarding the posthumous documentary of renowned chef Anthony Bourdain and the backlash it has garnered owing to its use of AI narration and the ethics surrounding such practices. The article highlights the grey area regarding the use of Al where it is being used, to deceive people, but also its beneficial application for documentary purposes.
This is a perfect illustration of how people are too sceptical of new forms of knowledge merely because they do not fit into their current accepted ideas, resulting in a decline in the use of new knowledge, in this case, artificial intelligence. However, the usefulness of Al has become more widely recognised as time has passed. As a community of knowers, we prefer to use Al not only to make our lives easier, but also to verify our knowledge in order to attain a level of certainty. Additionally, our reliability in Al may be the cause of humans constantly doubting themselves and making errors, something Al does not have. 
This particular article discusses the ethical concerns with such practices and the extent to which people are willing to go for profits and convenience. According to the Future Of Public Forum, Chinese researchers have come up with an Al algorithm that can help assess a patient's survival rate if infected with Covid - 19. Based on a set of AI tests, the algorithm assigns patients to a high or low priority group. This grim scenario forces us to consider whether we should enable Al to be deployed in every industry simply because it is possible, or whether we should prioritise ethics in such situations.